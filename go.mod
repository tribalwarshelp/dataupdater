...
require (
	github.com/Kichiyaki/go-php-serialize v0.0.0-20200601110855-47b6982acf83 // indirect
	github.com/Kichiyaki/gopgutil/v10 v10.0.0-20210521204542-cc672e361b3d // indirect
